...
export function ContactSection() {
  ...
  return (
    <section id="contact" className="py-20 relative">
      <div className="absolute inset-0 bg-[radial-gradient(circle_at_bottom_right,rgba(255,97,0,0.1),transparent_70%)]"></div>
      <div className="container relative z-10">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 max-w-5xl mx-auto">
                ...
                <form onSubmit={handleSubmit}>
                  ...
                  <div className="mb-6">
                    ...
                    <Textarea
                      ...
                      className="bg-black/50 border-orange-500/20 focus:border-orange-500 min-h-[150px]"
                      required
                    />
                  </div>
          ...
          <div>
            <Card className="bg-black/50 border border-orange-500/20 h-full">
              <CardContent className="p-6 flex flex-col justify-between h-full">
                ...
                <div className="mt-8">
                  ...
                  <div className="flex gap-3">
                    <a
                      href="#"
                      className="bg-orange-500/10 p-3 rounded-full hover:bg-orange-500 hover:text-black transition-colors"
                    >
                    ...
                    >
                      <svg className="h-5 w-5" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
                        <path
                          fillRule="evenodd"
                          d="M12 2C6.48 2 2 6.48 2 12s4.48 10 10 10c5.51 0 10-4.48 10-10S17.51 2 12 2zm-1.41 7.08c.84-.58 1.87-.93 2.98-.93 1.11 0 2.14.35 2.98.93a4.007 4.007 0 011.76 2.92c0 1.11-.35 2.14-.93 2.98a4.007 4.007 0 01-2.92 1.76c-1.11 0-2.14-.35-2.98-.93a4.007 4.007 0 01-1.76-2.92c0-1.11.35-2.14.93-2.98a4.007 4.007 0 012.92-1.76zm-.99 5.92c0 1.1.9 2 2 2s2-.9 2-2-.9-2-2-2-2 .9-2 2z"
                          clipRule="evenodd"
                        />
                      </svg>
                    </a>
